...
The project works at O(n^4) with a matrix of 50 people in worst possible conditions taking 60 second to complete. It is intended for use personally so this upper limit poses no real issue at present.
